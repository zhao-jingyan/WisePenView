...
import { WISEPEN_INLINE_COMMENT_MARK_SYNC_META } from '../../../engines/inlineComment/anchors/range';
import type { CustomBlockNoteEditor } from '../../../noteEditorComposition';
import type { FormulaInlineCommentPosition } from './formulaInlineCommentAnchor';
...
export function applyFormulaInlineCommentMark(
  editor: CustomBlockNoteEditor,
  threadId: string,
  position: FormulaInlineCommentPosition
): boolean {
