...
import type { CollaboratorCommentVisibility } from './document';

export type ThreadVisibilityScope = {
 ...
 */
function isThreadVisibleToUser(thread: ThreadData, scope: ThreadVisibilityScope): boolean {
  if (thread.deletedAt) {
    return false;
  }
