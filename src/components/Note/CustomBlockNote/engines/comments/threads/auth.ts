...
import { getThreadComments } from './presentation';

/** 与 BlockNote 默认权限模型一致的文档评论角色。 */
export type BlockNoteCommentDocumentRole = 'comment' | 'editor';
...
export class WisePenThreadStoreAuth extends ThreadStoreAuth {
  ...
  constructor(getUserId: () => string, role: BlockNoteCommentDocumentRole, isPrivileged: boolean) {
    super();
